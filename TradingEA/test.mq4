...
//---
   ...
   PrintFormat("Market Point : %f", MarketInfo(symbol,MODE_POINT));
   PrintFormat("Market MODE_TICKVALUE : %f", MarketInfo(symbol,MODE_TICKVALUE));
   PrintFormat("Market MODE_TICKSIZE : %f", MarketInfo(symbol,MODE_TICKSIZE));
